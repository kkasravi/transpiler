...
/*
              stack.top().tab().add("Object.getOwnPropertyDescriptor(");
              @transpfiler.get(name).emit(stack);
              stack.top().add(".prototype,").add("'").add(privateDecl.name.name).add("') || ").
                add("Object.defineProperty(");
              @transpiler.get(name).emit(stack);
              stack.top().add(".prototype,").add("'").add(privateDecl.name.name).add("', {get: function(){return ").
                add(privateDecl.name.name).add(";},").add('set: function(e){').add(privateDecl.name.name).add('=e;').
                add("}});").newLine();
*/
